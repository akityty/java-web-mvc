...
@WebServlet(name = "CustomerService", urlPatterns = "/customers")
public class CustomerServlet extends javax.servlet.http.HttpServlet {
  ...
  private void showFindByNameForm(HttpServletRequest request, HttpServletResponse response) {
    RequestDispatcher dispatcher;
    dispatcher =request.getRequestDispatcher("customer/findByName.jsp");
    String name = request.getParameter("name");
    ...
    if(customer == null){
      ...
      request.setAttribute("customer",customer);
      dispatcher = request.getRequestDispatcher("customer/resultFindByName.jsp");
      try{
        dispatcher.forward(request,response);
      } catch (ServletException | IOException e) {
        e.printStackTrace();
